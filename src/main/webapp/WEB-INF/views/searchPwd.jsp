...
<jsp:include page="/WEB-INF/views/include_h.jsp"/>
    ...
    <div class="container-fluid page-header py-5 mb-5">
        <div class="container py-5">
            <h1 class="display-3 text-white mb-3 animated slideInDown">패스워드 찾기</h1>
                ...
                <div class="col-lg-6 feature-text py-5 wow fadeIn" data-wow-delay="0.5s">
                    <div class="p-lg-5 ps-lg-0">
                        <div class="section-title text-start">
                            <h1 class="display-5 mb-4">패스워드 찾기</h1>
                        </div>
                        <p class="mb-4 pb-2"></p>
                        <form action="searchPwdOk.do" method="post" autocomplete="off">
                        <div class="row g-3">
	                        ...
	                        <div class="col-12 col-sm-8">
	                     	   <input type="text" id="id" name="id" class="form-control border-0" placeholder="아이디 " onkeydown="chkSpace()" title="이름 " maxlength="12" style="height: 55px;">
	                        </div>
	                        <div class="col-12 col-sm-4">
	                        ...
	                        <div class="col-12 col-sm-6" >
			                    <input type="button" class="btn btn-primary w-100 py-3" onclick="searchPwdGo(this.form)" value="인증번호 받기" style="height: 60px; font-weight: bold; font-size: 1.5em;">
			                </div>
	                        <div class="col-12 col-sm-6" >
